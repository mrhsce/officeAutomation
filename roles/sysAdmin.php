...
<div class="main">
    ...
    <!-- Showing tables -->
    <button class="show-tables" type="button" >Show tables</button>
    <!-- Showing basic tables -->
    <button class="show-basicTables" type="button" >Show basic tables</button>
    <!-- Showing number codes -->
    <button class="show-codes" type="button" >Show codes</button>
    <hr>
    <button class="logout" type="button">Log out</button>

</div>

<div class="show-userList" style="display: none;">

</div>

<div class="show-tables" style="display: none;">
...
<div class="show-codes" style="display: none;">
