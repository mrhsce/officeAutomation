        ...
        <div class="container-fluid">
            <form class="add-employee-form">
                <div class="container-fluid row">
                    ...
                    <div class="container-fluid col col-lg-3">
                        ...
                        <div class="container-fluid row">
                            ...
                            <input class="col col-lg-6" name="childrenNumber" id="childrenNumber" value="0" type="number">
                    ...
                    <div class="container-fluid col col-lg-3">
                        ...
                        <div class="container-fluid row">
                            ...
                            <input class="col col-lg-6" name="average" id="average" value="10" min="0" max="20" step="0.01" type="number">
                        </div>
                ...
                <div class="container-fluid center-align row">
                    <button class="submit-add-employee-form" type="button">Register</button>
                </div>
